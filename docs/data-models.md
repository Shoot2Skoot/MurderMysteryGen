...
**(Note: The JSON schema below should be replaced with the full output of `print(CaseContext.model_json_schema(indent=2))` after all Phase 2 model updates are finalized in `src/mystery_ai/core/data_models.py`)**
...
```json
{
  "$defs": {
    ...
    "SuspectProfile": {
      ...
      "properties": {
        ...
        "description": {
          "description": "A brief description of the suspect.",
          "title": "Description",
          "type": "string"
        },
  ...
  "properties": {
    ...
    "thematic_first_names": {
      "description": "A list of thematically appropriate first names for the given theme.",
      "items": {
        "type": "string"
      },
      "title": "Thematic First Names",
      "type": "array"
    },
    "thematic_last_names": {
      "description": "A list of thematically appropriate last names for the given theme.",
